...
public class CreateTableMain {
	public static void main(String[] args) {
		//자바에서 create,alter,drop문장 모두 사용 가능(DDL)
		...
		try {
			...
			/*
			 * 테이블을 생성하는 SQL문
			 * 접속한 계정(c##user001)에 테이블명이 중복되면 에러가 발생하기 때문에 동일 계정에서는 한 번만 수행
			 */
			...
			//자원정리-conn먼저 생성 후 stmt가 생성되었으므로 stmt 먼저 정리하기(역순)
