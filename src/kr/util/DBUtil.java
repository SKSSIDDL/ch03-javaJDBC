...
import java.sql.CallableStatement; //프로시저 호출
...
public class DBUtil {
	...
	public static Connection getConnection() throws ClassNotFoundException, SQLException { //static이라 일반변수 호출 불가->private static final 사용
		//JDBC 수행 1단계 : 드라이버 로드
